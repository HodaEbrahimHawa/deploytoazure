...
/* harmony import */ var _spinner_loading_spinner_loading_spinner_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./spinner/loading-spinner/loading-spinner.component */ "./src/app/components/spinner/loading-spinner/loading-spinner.component.ts");
...
let HttpService = class HttpService {
    ...
    post(path, body = {}) {
        ...
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl}/api/${path}`, JSON.stringify(body), { headers: this.headers });
    }
